...
<html lang="en">
    ...
    <body>
                ...
                <div class="modal-content ">
                    <form>
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label fs-2" >User ID</label>
                                <input type="email" class="form-control fs-2 p-1" required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label fs-2">Password</label>
                                <input type="password" class="form-control fs-2" required >
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
                                <button type="submit" class="btn btn-dark fs-3 shadow-none">LOGIN</button>
                            </div>
                        </div>
                    </form>
        ...
        <div class="modal fade" id="registermodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="exampleInputEmail1" class="form-label fs-2" >User ID</label>
                                        <input type="text" class="form-control fs-2 p-1" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleInputEmail1" class="form-label fs-2" >Phone Number</label>
                                        <input type="number" class="form-control fs-2 p-1" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="exampleInputEmail1" class="form-label fs-2" >Picture</label>
                                        <input type="file" class="form-control fs-2 p-1" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="exampleInputEmail1" class="form-label fs-2" >Password</label>
                                        <input type="password" class="form-control fs-2 p-1" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="exampleInputEmail1" class="form-label fs-2" >Cofirm Password</label>
                                        <input type="password" class="form-control fs-2 p-1" required>
                                    </div>
                                </div>
                                <div class="text-center my-1">
                                    <button type="submit" class="btn btn-dark fs-3 shadow-none">REGISTER</button>
         ...
         <div class="my-5 px-1">
            <h2 class="fw-bold text-center fs-1">PRODUCT CATEGORY</h2>
        </div>
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <a href="flowering.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <a href="nonFlowering.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <a href="indoor.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <a href="outdoor.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <a href="succulents.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <a href="medicinal.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <a href="pots.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <a href="gardenTools.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="content">
                        <h3>Pesticides</h3>
                        <a href="pesticides.php" class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2">Shop Now</a>
                    </div>
                </div>
        ...
        <section class="product" id="product">
         ...
         <h1 class="heading fw-bold">New products </h1>
            ...
            <!--                    <div class="stars">
                    ...
                    <div class="price fs-2 mt-2"><?php echo " $".$row['unitPrice'] ?> <!--<span>$18.20</span>--></div>
                        <a class="text-decoration-none btn btn-outline-success shadow-none mt-2 fs-4 fs-2 " href="?action=addCart&id=<?php echo $row['productID']?>" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
