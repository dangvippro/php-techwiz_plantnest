...
<body>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item active fs-4" style="background-color: #198754" href="pots.php">Pots</a></li>
    ...
    <section class="product" id="product">
        ...
        <h2 class="heading fw-bold">Pots</h2>
        <a href="" class="text-secondary text-decoration-none fs-3 ">Home</a>
        <span class="text-secondary fs-3"> > </span>
        <a href="pots.php" class="text-secondary text-decoration-none fs-3">Pots</a>
        <!--find pots-->
        ...
        if (isset($_POST['findProduct'])) {
            $name = $_POST['keyword'];
            $listProduct = $product->findProducts($conn, $name, 7);
        ?>
            <div class="container">
