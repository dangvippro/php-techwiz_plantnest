...
if (isset($_SESSION['role']) && ($_SESSION['role'] == 0)) {
    ...
    include_once '../classes/UserReview.php';
    ...
    <body>
                            ...
                            <a href="manageAccount.php">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu mt-2" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <li><a class="dropdown-item active fs-3 " style="background-color: #198754" href="review.php">Review</a></li>
        ...
        if (isset($_SESSION['name']) && ($_SESSION['name'] != "")) {
            ...
            if(isset($_GET['action']) && $_GET['action'] == "review"){
                ...
                if(isset($_POST['submit']) && $_POST['review'] != ""){
                    $rating = $_POST['rating'];
                    $review = $_POST['review'];
                    if($userReview->addReview($conn, $userID, $rating, $review, $productID)){
                        echo "New review add successfully!";
        ...
        <?php 
        if (isset($_SESSION['name']) && ($_SESSION['name'] != "")) {
        $result = $order->userOrdered($conn, $_SESSION['id']);
        }
        ?>
                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <a href="manageAccount.php" class="text-secondary text-decoration-none fs-2"><font color="#198754">My Account</font></a><span class="text-secondary text-decoration-none fs-2 mt-3"> / Review Product</span>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a class="body-container-edit" href="review.php?action=review&productID=<?php echo $row["productID"] ?>">
                                            ...
                                            <?php
                                                ...
                                                echo 'You do not have a successful order to rate.';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
        ...
        ?>
        <div>
            <div class="bg-white p-3 p-md-5 rounded shadow-sm">
                <a href="manageAccount.php" class="text-secondary text-decoration-none fs-2"><font color="#198754">My Account</font></a><span class="text-secondary text-decoration-none fs-2"> / Review Product</span>
                <form id="info-form" action="" method="POST" style="width: 50%; margin-left: 24%;">
                    <h1 class="text-center mb-4">Review Product</h1>
                    <table class="position-absolute top-50 start-50 translate-middle" style="margin:0px 0px 50px 200px; width: 50%;">
                        <div class="modal-content">
                            <div class="modal-header ">
                                <h5 class="modal-title d-flex fs-1  ">
                                    <i class="bi bi-chat-square-heart-fill fs-1 me-2"></i> Rate & Review
                                </h5>
                                <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label class="form-label fs-3 ">Rating</label>
                                    <select class="form-select shadow-none fs-3" name="rating">
                                ...
                                <div class="mb-4">
                                    <label class="form-label fs-3">Review</label>
                                    <textarea type="password" name="review" rows="3" required class="form-control shadow-none fs-3" ></textarea>
                                </div>
                                <input type="hidden" name="booking_id">
                                <input type="hidden" name="room_id">
                                <div class="text-center" >
                                    <input type="submit" name="submit" class="btn btn-outline-success shadow-none me-lg-3 me-3 fs-2" value="Submit">
                                </div>
                            </div>
                        </div>
                    </table>
