...
<body>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item active fs-4" style="background-color: #198754" href="outdoor.php">Outdoor</a></li>
    ...
    <section class="product" id="product">
        ...
        <h2 class="heading fw-bold">Outdoor Plants</h2>
        <a href="" class="text-secondary text-decoration-none fs-3 ">Home</a>
        <span class="text-secondary fs-3"> > </span>
        <a href="outdoor.php" class="text-secondary text-decoration-none fs-3">Outdoor</a>
        <!--find outdoor plants-->
        ...
        if (isset($_POST['findProduct'])) {
            $name = $_POST['keyword'];
            $listProduct = $product->findProducts($conn, $name, 4);
        ?>
            <div class="container">
        ...
        ?>
            <div class="product-section mt-150 mb-150">
                <?php
                $result = $product->showOutdoor($conn);
