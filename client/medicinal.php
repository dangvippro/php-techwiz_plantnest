...
<body>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item active  fs-4" style="background-color: #198754" href="medicinal.php">Medicinal</a></li>
    ...
    <section class="product" id="product">
        ...
        <h2 class="heading fw-bold">Medicinal Plants</h2>
        <a href="" class="text-secondary text-decoration-none fs-3 ">Home</a>
        <span class="text-secondary fs-3"> > </span>
        <a href="medicinal.php" class="text-secondary text-decoration-none fs-3">Medicinal</a>
        <!--find medicinal-->
        ...
        if (isset($_POST['findProduct'])) {
            $name = $_POST['keyword'];
            $listProduct = $product->findProducts($conn, $name, 6);
        ?>
            <div class="container">
        ...
        ?>
            <div class="product-section mt-150 mb-150">
                <?php
                $result = $product->showMedicinal($conn);
