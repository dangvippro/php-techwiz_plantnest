...
<body>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item active fs-4" style="background-color: #198754" href="gardenTools.php">Garden Tools</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
    ...
    <section class="product" id="product">
        ...
        <h2 class="heading">Garden Tools</h2>
        <a href="" class="text-secondary text-decoration-none fs-3 ">Home</a>
        <span class="text-secondary fs-3"> > </span>
        <a href="gardenTools.php" class="text-secondary text-decoration-none fs-3">GardenTools</a>
        <!--find garden tools-->
        ...
        if (isset($_POST['findProduct'])) {
            $name = $_POST['keyword'];
            $listProduct = $product->findProducts($conn, $name, 8);
        ?>
            <div class="container">
        ...
        <!--display garden tools-->
        <?php
        if (!isset($_POST['findProduct'])) {
        ?>
            <div class="product-section mt-150 mb-150">
                <?php
                $result = $product->showGardenTools($conn);
                                    ...
                                    <form method="GET">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="price fs-2 mt-2"><?php echo "$" . $row['unitPrice'] ?> <!--<span>$18.20</span>--></div>
                                                <button type="submit" class="btn-outline-success shadow-none mt-2 fs-4 fs-2" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</button>
