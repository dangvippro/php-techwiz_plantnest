...
<head>
    ...
    <title>Non-Flowering Plants</title>
...
<body>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item active fs-4" style="background-color: #198754" href="nonFlowering.php">Non-flowering</a></li>
    ...
    <section class="product" id="product">
        ...
        <h2 class="heading fw-bold">Non-Flowering Plants</h2>
        <a href="" class="text-secondary text-decoration-none fs-3 ">Home</a>
        <span class="text-secondary fs-3"> > </span>
        <a href="nonFlowering.php" class="text-secondary text-decoration-none fs-3">Non-Flowering</a>
        <!--find non-flowering plants-->
        ...
        if (isset($_POST['findProduct'])) {
            $name = $_POST['keyword'];
            $listProduct = $product->findProducts($conn, $name, 2);
        ?>
            <div class="container">
        ...
        <!--display non-flowering plants-->
        <?php
        if (!isset($_POST['findProduct'])) {
        ?>
            <div class="product-section mt-150 mb-150">
                <?php
                $result = $product->showNonFlowering($conn);
