...
<body>
    ...
    if (isset($_SESSION['favorites'])) {
        $total_quantity = 0;
        $total_price = 0;
        // foreach ($_SESSION['favorites'] as $x => $value) {
        //     echo $value['name'] . " added to favorites.";
        // }
    }
    // else {
    //     echo 'Cart is empty.';
                            ...
                            <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        <a class="nav-link active text-success dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Product
                                        </a>
                                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item active fs-4" style="background-color: #198754" href="pesticides.php">Pesticides</a></li>
    ...
    <section class="product" id="product">
        ...
        <h2 class="heading fw-bold">Pesticides</h2>
        <a href="" class="text-secondary text-decoration-none fs-3 ">Home</a>
        <span class="text-secondary fs-3"> > </span>
        <a href="pesticides.php" class="text-secondary text-decoration-none fs-3">Pesticides</a>
        <!--find pesticides-->
        ...
        if (isset($_POST['findProduct'])) {
            $name = $_POST['keyword'];
            $listProduct = $product->findProducts($conn, $name, 9);
        ?>
            <div class="container">
                        ...
                        <div class="col-md-3 mt-3">
                            <form method="GET">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h3><a class="text-decoration-none text-dark fs-4 mt-2 fw-bold" href="productdetails.php?action=singleproduct&id=<?php echo $row['productID'] ?>&caID=<?php echo $row['categoryID'] ?>"><?php echo $row['productName'] ?></a></h3>
        ...
        ?>
            <div class="product-section mt-150 mb-150">
                <?php
                $result = $product->showPesticides($conn);
                                ...
                                <div class="col-md-3 mt-3">
                                    <form method="GET">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h3><a class="text-decoration-none text-dark fs-3 mt-2 fw-bold" href="productdetails.php?action=singleproduct&id=<?php echo $row['productID'] ?>&caID=<?php echo $row['categoryID'] ?>"><?php echo $row['productName'] ?></a></h3>
