...
<body>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item active fs-4" href="succulents.php" style="background-color: #198754">Succulents</a></li>
    ...
    <section class="product" id="product">
        ...
        <h2 class="heading fw-bold">Succulents</h2>
        <a href="" class="text-secondary text-decoration-none fs-3 ">Home</a>
        <span class="text-secondary fs-3"> > </span>
        <a href="succulents.php" class="text-secondary text-decoration-none fs-3">Succulents</a>
        <!--find succulents-->
        ...
        if (isset($_POST['findProduct'])) {
            $name = $_POST['keyword'];
            $listProduct = $product->findProducts($conn, $name, 5);
        ?>
            <div class="container">
        ...
        ?>
            <div class="product-section mt-150 mb-150">
                <?php
                $result = $product->showSucculents($conn);
