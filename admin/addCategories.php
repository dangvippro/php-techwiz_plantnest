...
<?php
    if (isset($_POST['addCategories'])) {
        ...
        if ($categories->add($conn, $categoryName)) {
                ...
                <form method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10" style="margin-top: 20px;">
                            <button type="submit" class="btn btn-outline-dark" data-toggle="button" aria-pressed="false" name="addCategories"><i class="fa-solid fa-plus"></i> Add</button>
