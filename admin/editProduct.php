...
<body>
    <?php
    if (isset($_GET['action']) && $_GET['action'] == "editPro") {
        $proID = $_GET['productID'];
        $item = $product->findElementByID($conn, $proID);
    }
    ...
    if (isset($_POST['editProduct'])) {
        ...
        if ($product->edit($conn, $productName, $unitPrice, $height, $uses, $growthHabits, $light, $water, $categoryID, $imageURL, $unitsInStock, $productID)) {
    ...
    <div id="body">
        ...
        <div class="body-container" style="width: 100%;">
            <div class="body-container__welcome">
                <h2 style="margin-bottom: 1rem;">Product Information</h2>
                <div>
            ...
            <div class="body-container-form">
                <form method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="categoryID" name="productID" value="<?php echo $item["productID"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Product Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="productName" value="<?php echo $item["productName"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Unit price</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="unitPrice" value="<?php echo $item["unitPrice"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Height</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="height" value="<?php echo $item["height"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Uses</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="uses" value="<?php echo $item["uses"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Growth habits</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="growthHabits" value="<?php echo $item["growthHabits"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Light</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="light" value="<?php echo $item["light"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Water</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="water" value="<?php echo $item["water"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Image URL</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="imageURL" value="<?php echo $item["imageURL"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Units in stock</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="unitsInStock" value="<?php echo $item["unitsInStock"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Category ID</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="categoryID" value="<?php echo $item["categoryID"] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-10" style="margin-top: 20px;">
                            <button type="submit" class="btn btn-outline-dark" data-toggle="button" aria-pressed="false" name="editProduct"><i class="fa-regular fa-floppy-disk"></i> Update</button>
