...
<body>
    ...
    if (isset($_GET['search'])) {
        $keyword = $_GET['search'];
        $result = $order->findOrders($conn, $keyword);
    }
        ...
        <div class="body-container" style="width: 90%;">
            <div class="body-container-nav">
                <div class="body-container-refresh">
                    <a type="button" class="btn btn-outline-dark" href="manageOrders.php">
                        <i class="fa-solid fa-arrows-rotate"></i> Refresh
                    </a>
                </div>
                <div class="d-flex">
                    <form class="d-flex search" method="get" style="margin-right: 20px;">
                        <input type="form-control" style="border: none; padding: 6px 12px; border: 1px solid #ddd; outline: none;" name="search" id="search" placeholder="Enter status of orders" required>
