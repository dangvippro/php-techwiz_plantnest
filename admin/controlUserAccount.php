            ...
            <div class="body-container" style="width: 90%;">
                <div class="body-container-nav">
                    <div class="body-container-refresh">
                        <a type="button" class="btn btn-outline-dark" href="controlUserAccount.php">
                            <i class="fa-solid fa-arrows-rotate"></i> Refresh
                        </a>
                        <?php $count = countAccountUser($conn);
                        if($count->num_rows > 0) {
                            while ($row = $count->fetch_assoc()) {
                        ?>
                        <span class="btn btn-outline-dark">The total registered users: <?php echo $row['count(*)'] ?></span>
                        <?php } 
                        } ?>
                    </div>
<!--                    <div class="d-flex">
...
<!--                            <td style="text-align: center;">
                                <a class="body-container-delete" href="?action=deleteFeedback&userNo=<?php echo $row["userID"] ?>">
