...
<body>
    ...
    if (isset($_GET['action']) && $_GET['action'] == "edit") {
        ...
        $item = $categories->findElementByID($conn, $categoryID);
    }
    ...
    if (isset($_POST['editCategories'])) {
        ...
        if ($categories->edit($conn, $categoryID, $categoryName)) {
    ...
    <div id="body">
        ...
        <div class="body-container" style="width: 100%;">
            <div class="body-container__welcome">
                <h2 style="margin-bottom: 1rem;">Categories Information</h2>
                <div>
            ...
            <div class="body-container-form">
                <form method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="categoryID" name="categoryID" value="<?php echo $item["categoryID"] ?>">
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: 10px;">
                        <label class="col-sm-2 col-form-label">Category Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoryName" name="categoryName" value="<?php echo $item["categoryName"] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"></label>
                        <div class="col-sm-10" style="margin-top: 20px;">
                            <button type="submit" class="btn btn-outline-dark" data-toggle="button" aria-pressed="false" name="editCategories"><i class="fa-regular fa-floppy-disk"></i> Update</button>
